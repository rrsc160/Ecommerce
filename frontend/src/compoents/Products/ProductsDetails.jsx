...
const constsimilarProducts = [
    { _id: 1, name: "Product 1", price: 100, images: [{ url: "https://picsum.photos/500/500?random=3" }] },
    { _id: 2, name: "Product 1", price: 100, images: [{ url: "https://picsum.photos/500/500?random=4" }] },
    ...
    { _id: 5, name: "Product 3", price: 100, images: [{ url: "https://picsum.photos/500/500?random=7" }] },
    { _id: 6, name: "Product 4", price: 100, images: [{ url: "https://picsum.photos/500/500?random=8" }] },
    { _id: 7, name: "Product 3", price: 100, images: [{ url: "https://picsum.photos/500/500?random=9" }] },
    { _id: 8, name: "Product 4", price: 100, images: [{ url: "https://picsum.photos/500/500?random=10" }] }
];
        ...
        <div className='p-6'>
            <div className='max-w-6xl mx-auto bg-white p-8 rounded-lg'>
                ...
                <div className='mt-20'>
                    ...
                    <ProductGrid products={constsimilarProducts} />
                </div>
            </div>
        </div>
    );
